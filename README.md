...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/octivo-booking@0.1.3/dist/octivo-booking.min.css">
<script src="https://cdn.jsdelivr.net/npm/octivo-booking@0.1.3/dist/octivo-booking.min.js" data-channel="your-channel-slug" async></script>
```
